...
document.querySelectorAll('.articulo').forEach(articulo => {
    ...
    articulo.addEventListener('click', () => {
        ...
        let html_estructura = articulo.innerHTML
        document.getElementById("pop").style.display="flex";
        document.getElementById("cont-pop").innerHTML=html_estructura;
        // document.getElementById("cont-articulo").innerHTML=html_estructura;
    })
